...
export default function Edit({ gelombang, title }: { gelombang: any, title: string }) {
	...
	const { data, setData, put, processing, errors } = useForm({
		...
		tanggal_selesai: formatDate(gelombang.tanggal_selesai),
		tanggal_pengumuman: formatDate(gelombang.tanggal_pengumuman),
					...
					<form onSubmit={submit}>
						...
						<CardFooter>
							<Button type="submit" disabled={processing} className="w-full">
								{processing ? "Menyimpan Perubahan..." : "Simpan Perubahan Gelombang"}
							</Button>
						</CardFooter>
					</form>
				</Card>
