...
const advantages = [
	{
		...
		description: "Pembentukan karakter Qur'ani dan akhlak karimah",
	},
	{
		icon: Award,
	...
	},
	{
		...
		description: "Pengajar berpengalaman lulusan pesantren & PT ternama",
	},
	{
		icon: Building,
		title: "Fasilitas Memadai",
		description: "Sarana belajar yang lengkap dan nyaman bagi siswa",
	},
];
...
const facilities = [
	{
		icon: Building,
		name: "Ruang Kelas",
		description: "Ruang belajar nyaman & bersih",
	},
	{
		icon: Building,
		name: "Masjid Nurul Ulum",
		description: "Pusat kegiatan ibadah siswa",
	},
	{
		icon: Monitor,
		name: "Lab Komputer",
		description: "Fasilitas IT modern ber-AC",
	},
	{
		icon: BookOpen,
		name: "Lab IPA",
		description: "Ruang praktik sains lengkap",
	},
	{
		icon: BookOpen,
		name: "Perpustakaan",
		description: "Koleksi buku agama & umum",
	},
	{
		icon: Warehouse,
		name: "Aula Serbaguna",
		description: "Kegiatan seni & pertemuan",
	},
	{
		icon: Utensils,
		name: "Kantin Sehat",
		description: "Makanan higienis & terjangkau",
	},
	{
		icon: Dumbbell,
		name: "Lapangan Olahraga",
		description: "Futsal, Basket & Badminton",
	},
];
